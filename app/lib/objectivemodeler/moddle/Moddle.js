 ...
 *
 * @param {String}   xmlStr
 * @param {String}   [typeName='om:Definitions'] name of the root element
 ...
 *
 * @param {String}   element    the root element, typically an instance of `om:Definitions`
