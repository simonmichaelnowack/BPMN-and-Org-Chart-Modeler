 ...
 *
 * @param {String}   xmlStr
 * @param {String}   [typeName='gm:Definitions'] name of the root element
 ...
 *
 * @param {String}   element    the root element, typically an instance of `gm:Definitions`
