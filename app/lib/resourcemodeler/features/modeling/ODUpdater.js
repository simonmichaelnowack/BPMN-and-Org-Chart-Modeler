...
ODUpdater.prototype.updateConnection = function (context) {
  ...
  if (businessObject.sourceOrganizationalUnitRef !== newSource) {
    if (inverseSet) {
      collectionRemove(
        businessObject.sourceOrganizationalUnitRef &&
          businessObject.sourceOrganizationalUnitRef.get("links"),
        businessObject
      );
    ...
    businessObject.sourceOrganizationalUnitRef = newSource;
  }
  if (businessObject.targetOrganizationalUnitRef !== newTarget) {
    businessObject.targetOrganizationalUnitRef = newTarget;
  }
