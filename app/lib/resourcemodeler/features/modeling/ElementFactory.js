...
ElementFactory.prototype.createRootBoard = function (name, objective) {
  var rootBoard = this.createBusinessObject("odDi:OdRootBoard", {
    name: name,
    objectiveRef: objective,
  });
  var board = this.createBusinessObject("rem:OdBoard");
  rootBoard.plane = this.createBusinessObject("odDi:OdPlane", {
    boardElement: board,
  });
...
ElementFactory.prototype._getDefaultSize = function (semantic) {
  if (is(semantic, "rem:Position") || is(semantic, "rem:OrganizationalUnit")) {
