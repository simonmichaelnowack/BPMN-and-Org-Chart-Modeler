...
export default function ODCopyPaste(odFactory, eventBus, moddleCopy) {
  ...
  eventBus.on('copyPaste.copyElement', LOW_PRIORITY, function(context) {
    ...
    copyProperties(businessObject, descriptor, ['availabilityStart','availabilityEnd','roles']);
  ...
  eventBus.on('copyPaste.pasteElement', function(context) {
    ...
    copyProperties(descriptor, newBusinessObject, ['availabilityStart','availabilityEnd','roles']);
